...
# Rarefaction/extrapolation curve (*Figure S10A*) #type = 3: coverage based R/E curve 
...
out_Shannon$SampleType <- c(rep("CAV",6),rep("Normal HTx",12))
out_Richness$SampleType <- c(rep("CAV",6),rep("Normal HTx",12))
out_Simpson$SampleType <- c(rep("CAV",6),rep("Normal HTx",12))
...
ggplot(out_Shannon, aes(x=SampleType, y=Estimator)) +
  geom_boxplot(aes(fill=SampleType), width = 0.3) +
  theme_classic()+
  geom_point(aes(group = SampleType), position = position_dodge(0.75), size=0.5)+
  theme(axis.text.x = element_text(face = "bold", size=8, angle = 30, vjust = 0.75, hjust = 0.7), 
...
ggsave(filename = "output/10_clonotype/CD8T_Shannon_SampleType.png",
       width = 2, height=2.5, units = "in", bg = 'white')
...
ggplot(out_Richness, aes(x=SampleType, y=Estimator)) +
  geom_boxplot(aes(fill=SampleType), width = 0.3) +
  theme_classic()+
  geom_point(aes(group = SampleType), position = position_dodge(0.75), size=0.5)+
...
ggplot(out_Simpson, aes(x=SampleType, y=Estimator)) +
  geom_boxplot(aes(fill=SampleType), width = 0.3) +
  theme_classic()+
  geom_point(aes(group = SampleType), position = position_dodge(0.75), size=0.5)+
  theme(axis.text.x = element_text(face = "bold", size=7, angle = 20, vjust = 0.5), 
...
output2$SampleType <- c(rep("CAV",6), rep("Normal HTx",12))
...
ggplot(out_Shannon, aes(x=SampleType, y=Estimator)) +
  ...
  ylim(c(0,11.5))+
  xlab("") + ylab("Shannon Index")
ggsave(filename = "output/10_clonotype/CD4T_Shannon_SampleType.png",
       width = 2, height=2.5, units = "in", bg = 'white')
...
ggplot(out_Shannon, aes(x=SampleType, y=Estimator)) +
  ...
  ylim(c(0,10))+
  xlab("") + ylab("Shannon Index")
ggsave(filename = "output/10_clonotype/Bcell_Shannon_SampleType.png",
       width = 2, height=2.5, units = "in", bg = 'white')
