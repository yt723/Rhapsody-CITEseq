...
# *Excel file 5*
write.csv(de.results, file = "output/12_pseudobulk2/edgeR_dge_SampleType_CD8T.csv")
...
# *Excel file 5*
write.csv(de.results, file = "output/12_pseudobulk2/edgeR_dge_SampleType_CD4T.csv")
...
# *Excel file 5*
write.csv(de.results, file = "output/12_pseudobulk2/edgeR_dge_SampleType_Bcell.csv")
...
# *Excel file 5*
write.csv(de.results, file = "output/12_pseudobulk2/edgeR_dge_SampleType_NK.csv")
