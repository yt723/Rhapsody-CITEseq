...
FeatureScatter(CD8T, feature1 ="CD56",feature2 ="CD161", group.by = "cluster_name0.3",pt.size = 1.7)+   
  ...
  ggtitle("")
ggsave(file = paste0(path,"/output/11_CD8T_gating/FeatureScatter_CD8T_CD161_vs_CD56.png"),
...
FeatureScatter(CD161n_CD8T, feature1 ="CCR7",feature2 ="CD27", group.by = "CCR7CD27", pt.size = 1.7)+   
  ...
  ggtitle("")
ggsave(file = paste0(path,"/output/11_CD8T_gating/FeatureScatter_CD8T_CD27_vs_CCR7.png"),
       height = 5, width = 7, units = 'in', bg = 'white')
...
FeatureScatter(Tem_CD8T, feature1 ="CD38",feature2 ="HLA.DR", group.by = "cluster_name0.3", pt.size = 1.7)+   
  ...
  ggtitle("")
ggsave(file = paste0(path,"/output/11_CD8T_gating/FeatureScatter_CD8T_CD38_vs_HLADR.png"),
       height = 5, width = 7, units = 'in', bg = 'white')
...
FeatureScatter(Temra_CD8T, feature1 ="CD38",feature2 ="CD56", group.by = "cluster_name0.3", pt.size = 1.7)+   
  ...
  ggtitle("") 
ggsave(file = paste0(path,"/output/11_CD8T_gating/FeatureScatter_CD8T_CD38_vs_CD56.png"),
       height = 5, width = 7, units = 'in', bg = 'white')
...
FeatureScatter(CD161n_CD8T, feature1 ="CCR7",feature2 ="CD27", group.by = "Library")+   
  ...
  geom_hline(yintercept =1.9)+
  ggtitle("")
ggsave(file = paste0(path,"/output/11_CD8T_gating/FeatureScatter_CD8T_CD27_vs_CCR7_Library_integrated.png"),
       height = 5, width = 7, units = 'in', bg = 'white')
...
FeatureScatter(CD161n_CD8T, feature1 ="CCR7",feature2 ="CD27", group.by = "Library")+   
  ...
  geom_hline(yintercept =1.9)+
  ggtitle("")
ggsave(file = paste0(path,"/output/11_CD8T_gating/FeatureScatter_CD8T_CD27_vs_CCR7_Library_raw.png"),
       height = 5, width = 7, units = 'in', bg = 'white')
