...
CD8T <- readRDS(file = paste0(path, "/output/8_diffusion_map/CD8T_diffusion_map.rds"))
...
FeatureScatter(Lym, feature1 ="CD3",feature2 ="CD38", slot = 'data',
  ...
  xlab("CD3")+ ylab("CD38")+
  ggtitle("") 
ggsave(file = paste0(path, "/output/9_CD38_HLADR/CD3_vs_CD38_Biaxial_Plot_y1.3_pbmc.png"),
...
FeatureScatter(Myl, feature1 ="CD14",feature2 ="HLA.DR", slot = 'data',
  ...
  ggtitle("")
ggsave(file = paste0(path, "/output/9_CD38_HLADR/CD14_vs_HLADR_Biaxial_Plot_y2.4_pbmc.png"),
       width=8, height=6, units = "in", bg = 'white')
...
DimPlot(CD8T, group.by ="CD38HLADR", reduction = "wnn.umap", label = F, pt.size =1) + 
  ...
  NoAxes() +
  ggtitle("")
ggsave(file = paste0(path, "/output/9_CD38_HLADR/DimPlot_CD8T_CD38HLADR.png"),
...
ggsave(file = paste0(path, "/output/9_CD38_HLADR/DPT_CD8T_diffusion_CD38HLADR.png"),
       width=4, height=4.5, units = "in", bg = 'white') 


# save RDS file
saveRDS(CD8T, file = paste0(path, "/output/9_CD38_HLADR/CD8T_diffusion_map_CD38HLADR.rds"))
