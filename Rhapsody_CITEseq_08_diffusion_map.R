...
FeaturePlot(CD8T, features = 'pseudotime_dpt', reduction = 'wnn.umap',
  ...
  NoAxes() + ggtitle("")
ggsave(file = "output/8_diffusion_map/FeaturePlot_CD8T_DPT.png", 
...
ggsave(file = "output/8_diffusion_map/DPT_CD8T_diffusion_cluster_name0.3.png", 
       width=4.5, height=3, units = "in", bg = 'white')



# save RDS
saveRDS(CD8T, file = "output/8_diffusion_map/CD8T_diffusion_map.rds")
...
ggsave(file = "output/8_diffusion_map/DPT_CD8T_marker_vs_DPT.png", 
       width=4.5, height=3, units = "in", bg = 'white')
